...
t.test("defaultFile / sessionFile are sibling names; unknown kind is nil", function()
  t.eq(R.defaultFile("tuning"), "eh2_tuning.default.tbl")
  t.eq(R.sessionFile("uicfg"), "eh2_ui_config.session.tbl")
  t.eq(R.defaultFile("nope"), nil)
end)
