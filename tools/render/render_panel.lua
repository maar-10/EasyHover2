...
local RECIPES = {
  ...
  tuning_emrcvr = { W = 36, H = 10, build = function(b, f) return P("ui.basalt.bitconfig.tuning").build(b, f, nil, Nav.new("tuning"), readStub, noop, noop) end,
                  postBuild = function(h) h.elements.region:push("emrcvr") end },
